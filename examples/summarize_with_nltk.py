...
This version uses the NLTK sentence splitter to determine sentence boundaries.
It therefore requires a working NLTK installation. (http://www.nltk.org)
