...
import unittest
from MEDRank.computation.weighted_pageranker import *

# This class should pass the same tests as the PageRanker class
# so they are copied mercilessly from there :)
